...
CREATE TABLE `tblbusinessdependency` (
  ...
  `deciBusinessDependencyValue` decimal(8,2) DEFAULT NULL,
...
INSERT INTO `tblbusinessdependency` VALUES (1,'downpayment',20.00),(2,'reservationFee',1000.00),(3,'discountSpotcash',10.00),(4,'refund',50.00),(5,'penalty',2000.00),(6,'charge',1000.00),(7,'gracePeriod',7.00),(8,'voidReservationNoDownpayment',7.00),(9,'voidReservationNotFullPayment',14.00),(10,'voidOwnershipOverDue',1.00);
...
-- Dump completed on 2016-08-22 17:26:22
