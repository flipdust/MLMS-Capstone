...
if (isset($_POST['btnSubmit']))
      {
		...
		$createReservationAC =  new createReservationAC();
		$createReservationAC->Create($tfStatus,$dateCreated,$tfLastName,$tfFirstName,$tfMiddleName,$tfAddress,$tfContactNo,$typeOfPayment,
                                        $location,$tfAmount);
      }
...
if (isset($_POST['btnSave']))
      {
		...
		//echo "Record sucessfully saved";
		$tfReservationAshID = $_POST['tfReservationAshID'];
        $tfDate = $_POST['tfDate'];
        $tfLastName = $_POST['tfLastName'];
        $tfFirstName = $_POST['tfFirstName'];
        $tfMiddleName = $_POST['tfMiddleName'];
		...
		$updateReservationAC =  new updateReservationAC();
		$updateReservationAC->update($tfReservationAshID,$dateCreated,$tfLastName,$tfFirstName,$tfMiddleName,$tfAddress,$tfContactNo,
...
if (isset($_POST['btnDeactivate']))
      {
		...
		$deactivateReservationAC =  new deactivateReservationAC();
		$deactivateReservationAC->deactivate($tfReservationAshID,$location);
      }
...
<html lang = "en">
  <head>
		...
		<title>MLMS-Reservation for Ash Crypt</title>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('#datatables-reserveAsh').DataTable();
				  ...
				  <ul class="nav navbar-nav">
					...
					<li class="dropdown  active">
						...
						<ul class="dropdown-menu">
                            ...
                            <li class="active"><a href = "acReservation.php" style="text-align: right;">AC-UNIT</a></li>
                            <li class = "divider"></li>
            ...
            <div class="col-md-12">
                <div class="panel panel-success ">
                     <div class="panel-heading">
                         ...
                         <H2>RESERVATION FOR ASH-CRYPT</H2>
                     </div><!-- /.panel-heading -->
                      ...
                      <div class="panel-body">
                          ...
                          <div class="table-responsive col-md-12 col-lg-12 col-xs-12">
                              <table class="table table-bordered table-hover" id="datatables-reserveAsh">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                            $view = new reservationAC();
                                            $view->viewReservationAC();
                                        ?>
                                    </tbody>
                              </table>
