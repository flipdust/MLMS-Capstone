        ...
        if($result = mysql_query($sql,$conn))
        {
            while($row = mysql_fetch_array($result)){
                ...
                if(($row['curr'] + 1) > $row['max']){
                    echo "<script>alert('This Ash Crypt reach max limit of level!')</script>";
                }
                else{
                    	$createLevelAC =  new createLevelAC();
		                $createLevelAC->Create($tfLevelName,$acName,$tfNoOfUnit,$tfStatus,$tfSellingPrice);
                ...
                <ul class="nav side-menu">
                  <li style="font-size: 20px"><a><i class="fa fa-cog"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li class = "divider"></li>
                            ...
                            <li class = "active"><a href = "levelAsh.php" style="font-size: 12px">LEVEL</a></li>
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group" >
                            ...
                            <div class='form-group'>
                                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Name:</label>
                                <div class='col-md-7'>
                                     <input type='text 'class='form-control input-md' name= 'tfLevelName' onkeypress='return validateLevelName(event)' required/>
                                </div>
                            </div>
                                                        
                 <div class="form-group">
                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Ash Crypt Name:</label>
                <div class="col-md-7">
                  ...
                  <option value=""></option>
                      <?php
                        ...
                        $view->selectAC();
                            ...
                            <div class="form-group" >
                                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">No. of Unit:</label>
                                      <div class="col-md-7">
                            ...
                            <div class='form-group'>
                                 <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Selling Price:</label>
                                  <div class="col-md-7">
                  ...
                  <input class = "btn btn-default"  type="reset" name = "btnClear" value = "Clear">
                          ...
                          <div class="table-responsive col-md-8 col-lg-8 col-xs-8">
                              <table id="datatable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th class = "success" style = "text-align: center; font-size: 20px;">Level Name</th>
                                            <th class = "success" style = "text-align: center; font-size: 20px;">Ash Crypt Name</th>
