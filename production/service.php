      ...
      <div class="main_container">
                  ...
                  <li style="font-size: 20px"><a><i class="fa fa-cog"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li class = "divider"></li>
                      ...
                      <li><a href = "section.php" style="font-size: 12px">SECTION</a></li>
                            ...
                            <li class = "divider"></li>
                            <li  class = "active"><a href = "service.php" style="font-size: 12px">SERVICE</a></li>
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12">
                     ...
                     <div class="panel-heading">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="panel panel-success ">
                            ...
                            <div class="form-group">
                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Service Name:</label>
                                <div class="col-md-7">
              ...
              <div class='form-group'>
                               <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Service Price:</label>
                                <div class="col-md-7"> 
                                   <div class=' input-group'>
                                       <span class = 'input-group-addon'>₱</span>
                                       <input type='text 'class='form-control input-md' name= 'tfServicePrice' id='tfPriceCreate' required/>
                                   </div>
                                </div>
                            </div>
                                   ...
                                   <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class = "success" style = "text-align: center; font-size: 20px;">Service Name</th>
                                            <th class = "success" style = "text-align: center; font-size: 20px;">Service Price</th>
