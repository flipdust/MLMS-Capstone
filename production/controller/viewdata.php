    ...
    function viewTypes(){
		...
		while($row = mysql_fetch_array($result))
		  { 
                ...
                echo "<tr>
                          <td style = 'font-size:20px;'><b>$strTypeName</b></td>
                          <td style = 'font-size:20px;' align = 'right'>$intNoOfLot</td>
                          <td  align = 'right'>₱ ".number_format($dblSellingPrice,2)."</td>
                                        ...
                                        <div class = 'modal-body'>
                                            <form class='form-horizontal' role='form' action = 'typeoflot.php' method= 'POST'>						  
                                                ...
                                                <div class='row'>
                                                 ...
                                                 <div class='row'>     
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;' >No. of Lot:</label>
                                                        <div class='col-md-7'>
                                                ...
                                                <div class='row'>
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'> Selling Price:</label>
                                                        <div class='col-md-7'>
...
class interest{
    ...
    function viewInterest(){
		...
		$sql = "Select i.intInterestID, i.intYear, i.dblPercent,i.intStatus, t.strTypeName FROM tblinterest i
		...
		echo "<tr><td style = 'font-size:18px;'><b>$strTypeName</b></td>
							...
							<div class = 'modal-content' >
									...
									<div class = 'modal-body'>
										<form class='form-horizontal' role='form' action = 'interest.php' method= 'POST'>						  
                                            ...
                                            <div class='row'>              
											    <div class='form-group'>
												    <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Lot Type:</label>
												    <div class='col-md-7'>
                                            ...
                                            <div class='row'>
                                                <div class='form-group' >
                                                    <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>No. of Year:</label>
                                                    <div class='col-md-7'>
                                           ...
                                           <div class='row'>
                                               <div class='form-group'>
                                                   <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Percent:</label>
                                                   <div class='col-md-7'>
                                                        <div class=' input-group'>
    ...
    function viewSection(){
        ...
        $result = mysql_query($sql,$conn);
            ...
            while($row = mysql_fetch_array($result)){
                ...
                echo "<tr>
                          <td style ='font-size:20px;'><b>$strSectionName</b></td>
                          <td style = 'text-align: right; font-size: 20px;'>$intNoOfBlock</td>
                        ...
                        <div class = 'modal fade' id = 'update$intSectionID'>
                            <div class = 'modal-dialog' style = 'width: 40%;'>
                                <div class = 'modal-content'>
                                                    ...
                                                    <!--header-->
                                        <div class = 'modal-header' style='background:#7DCEA0  ;'>
                                            <button type = 'button' class = 'close' data-dismiss = 'modal'>&times;</button>
                                            <h2 class = 'modal-title'>Update:</h2>
                                        </div>
                                        ...
                                        <div class = 'modal-body'>
                                            <form class='form-horizontal' role='form' action = 'section.php' method= 'POST'>						  
                                                ...
                                                <div class='row'>
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Section Name:</label>
                                                        <div class='col-md-7'>
                                                 ...
                                                 <div class='row'>     
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>No. of Block(s):</label>
                                                        <div class='col-md-7'>
...
class block{
    ...
    function viewBlock(){
		...
		$sql = "SELECT b.intBlockID, b.strBlockName, b.intNoOfLot, b.intStatus, t.strTypeName, s.strSectionName FROM tblblock b INNER JOIN tblsection s 
                ...
                echo "<tr>
                          <td style ='font-size:20px;'><b>$strBlockName</b></td>
                          <td style ='font-size:20px;'> $strTypeName</td>
                                ...
                                <div class = 'modal-content'>
                                        ...
                                        <div class = 'modal-body'>
                                            <form class='form-horizontal' role='form' action = 'block.php' method= 'POST'>						  
                                                ...
                                                <div class='row'>
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Block Name:</label>
                                                        <div class='col-md-7'>
                                                ...
                                                <div class='row'>
                                                    <div class='form-group'>
												        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Type of Block:</label>
												        <div class='col-md-7'>
                                             ...
                                             <div class='row'>
                                                <div class='form-group'>
                                                    <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>No. of Unit:</label>
                                                    <div class='col-md-7'>
                                                        <input type='number' class='form-control input-md' min='1' name= 'tfNoOfLot' value= '$intNoOfLot' onkeypress='return validateNumber(event)' required/>
                                                    </div>
                                                </div>
...
class lot{
    ...
    function viewLot(){
		...
		while($row = mysql_fetch_array($result)){ 
          ...
          echo 
			  "<tr><td style ='font-size:18px;'><b>$strLotName</b></td>
							...
							<div class = 'modal-content'>
									...
									<div class = 'modal-body'>
										<form class='form-horizontal' role='form' action = 'lot.php' method= 'POST'>						  
											...
											<div class='row'>
                                                <div class='form-group'>
											        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Lot Name:</label>
												    <div class='col-md-7'>
                                            ...
                                            <div class='row'>
                                                <div class='form-group'>
												<label for = 'sel1' class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Block Name:</label>
												    <div class='col-md-7'>
                                            ...
                                            <div class='row'>
                                                <div class='form-group'>
												<label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Lot Status:</label>
												    <div class='col-md-7'>
...
class ashCrypt{
    ...
    function viewAshCrypt(){
		...
		echo "<tr><td style ='font-size:20px;'><b>$strAshName</b></td>
							...
							<div class = 'modal-content'>
									...
									<div class = 'modal-body'>
										<form class='form-horizontal' role='form' action = 'ashcrypt.php' method= 'POST'>						  
											...
											<div class='row'>
                                                <div class='form-group'>
											        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Ash Crypt Name:</label>
												    <div class='col-md-5'>
                                            ...
                                            <div class='row'>
                                                <div class='form-group'>
                                                    <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>No. of Level:</label>
                                                    <div class='col-md-5'>
    ...
    function viewLevelAC(){
		...
		while($row = mysql_fetch_array($result))
		  { 
			...
			echo "<tr>
                    <td style ='font-size:18px;'><b>$strLevelName</b></td>
							...
							<div class = 'modal-content'>
									...
									<div class = 'modal-body'>
										<form class='form-horizontal' role='form' action = 'levelAsh.php' method= 'POST'>						  
											...
											<div class='row'>
                                                <div class='form-group'>
											        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Level Name:</label>
												    <div class='col-md-7'>
...
class interestForLevel{
    ...
    function viewInterest(){
		...
		$sql = "SELECT iL.intInterestID, iL.intYear, iL.dblPercent, iL.intStatus, l.strLevelName, a.strAshName FROM tblinterestforlevel iL
		...
		echo "<tr><td style ='font-size:20px;'>$strLevelName ($strAshName)</td>
				   <td style = 'text-align: right; font-size:20px;'>$intYear</td>
				   <td style = 'text-align: right; font-size:20px;'>$dblPercentValue %</td>
		...
		while($row = mysql_fetch_array($result))
		  { 
            ...
            if($intUnitStatus==0){
			 ...
			 echo "<tr>
                        <td style ='font-size:18px;'><b>$strUnitName<b></td>
							...
							<div class = 'modal-content'>
									...
									<div class = 'modal-body'>
										<form class='form-horizontal' role='form' action = 'ashcryptUnit.php' method= 'POST'>						  
											...
											<div class='row'>
                                                <div class='form-group'>
											         <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Unit Name:</label>
												     <div class='col-md-7'>
                                            ...
                                            <div class='row'>
                                             ...
                                             <div class='row'>
                                                <div class='form-group' >
                                                    <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Capacity:</label>
                                                    <div class='col-md-7'>
                                             ...
                                             <div class='row'>
                                                <div class='form-group'>
												    <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Status:</label>
												    <div class='col-md-7'>
													   <select class='form-control input-md' name = 'status' required>";
...
class service{
    ...
    function viewService(){
	 ...
	 echo 
			  "<tr>
				   <td style ='font-size:18px;'><b>$strServiceName</b></td>
                                ...
                                <div class = 'modal-content'>
                                        ...
                                        <div class = 'modal-body'>
                                            <form class='form-horizontal' role='form' action = 'service.php' method= 'POST'>						  
                                                ...
                                                <div class='row'>
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Service Name:</label>
                                                        <div class='col-md-7'>
                                                ...
                                                <div class='row'>
                                                    <div class='form-group'>
                                                        <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Service Price:</label>
                                                        <div class='col-md-7'> 
                                                            <div class='input-group'>
                                                                <span class = 'input-group-addon'>₱</span>
						...
						<div class = 'modal-body'>
							<form class='form-horizontal' role='form' action = 'discount.php' method= 'POST'>						  
								 ...
								 <div class='form-group'>
								  ...
								  <div class='row'>
                                       <div class='form-group'>
                                            <label class='col-md-4' style = 'font-size: 18px; margin-top:.30em;'>Description:</label>
                                            <div class='col-md-7'>
