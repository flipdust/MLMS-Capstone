        ...
        if($result = mysql_query($sql,$conn))
        {
            while($row = mysql_fetch_array($result)){
                ...
                if(($row['curr'] + 1) > $row['max']){
		            ...
		            $createLot->Create($tfLotName,$typeBlock,$lotStatus,$tfStatus);
                }
            }
        }
                ...
                <ul class="nav side-menu">
                  <li style="font-size: 20px"><a><i class="fa fa-cog"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li class = "divider"></li>
                            ...
                            <li class = "active"><a href = "lot.php" style="font-size: 12px">LOT-UNIT</a></li>
          ...
          <div class = "row">
            <div class="col-md-12">
                ...
                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Name:</label>
                                 <div class="col-md-7">
                         <input type="text" class="form-control input-md" name= "tfLotName" required>
                         </div>
               </div>
                                                          
                           <div class="form-group">
                 <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Block Name:</label>
                                    <div class="col-md-7">
                           ...
                           <div class='form-group'>
                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">Lot Status:</label>
                                <div class='col-md-7'>
                                    <select class='form-control input-md' name = 'lotStatus' required>
