                  ...
                  <li style="font-size: 20px"><a><i class="fa fa-cog"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li class = "divider"></li>
                      ...
                      <li><a  href = "section.php" style="font-size: 12px">SECTION</a></li>
                            ...
                            <li class = "divider"></li>
                            <li  class = "active"><a href = "ashcrypt.php" style="font-size: 12px">ASH CRYPT</a></li>
                     ...
                     <div class="panel-heading">
                      ...
                      <div class="panel-body">
                            ...
                            <div class='form-group'>
                             ...
                             <div class="form-group" >
                                 <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">No. of Level:</label>
                                 <div class="col-md-7">
