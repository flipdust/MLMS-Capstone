...
if (isset($_POST['btnSubmit']))
      {
		...
		$createInterest->Create($level,$tfNoOfYear,$tfPercentValue,$tfStatus);
      }
...
<html lang="en">
  <head>
    ...
    <title>MLMS-Level-Interest</title>
                ...
                <ul class="nav side-menu">
                  <li style="font-size: 20px"><a><i class="fa fa-cog"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li class = "divider"></li>
                            ...
                            <li class = "active"><a href = "interest.php" style="font-size: 12px">INTEREST RATE</a></li>
                     ...
                     <div class="panel-heading">
                      ...
                      <div class="panel-body">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-7">
                                   <select class="form-control input-md" name = "level" required>
                                   <option value=""></option>
                                            <?php
                           ...
                           <div class="form-group" >
                                <label class="col-md-4" style = "font-size: 18px;" align="right" style="margin-top:.30em">No. of Year:</label>
                                <div class="col-md-7">
                                    <input type="number" class="form-control input-md" min="1" name="tfNoOfYear" required/>
                                </div>
                           </div>
	                         ...
	                         <div class='form-group'>
                                 ...
                                 <div class="col-md-7">
                                     <div class='input-group'>
                                        <input type='text 'class='form-control input-md' name= 'tfPercent' id='$intDiscountID' onkeypress='return validateNumber(event)' required/>
