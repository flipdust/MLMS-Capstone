                          ...
                          <span>December 30, 2014 - January 28, 2015</span> <b class="caret"></b>
                                        ...
                                        <div class="table-responsive col-md-12 col-lg-12 col-xs-12">
                                             <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    <thead>
                                                      <tr>
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Date Started</th>
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Customer Name</th>
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Pre-need/At-Need</th>
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Installment Rate</th>
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Total Amount Price</th> 
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Total Amount Paid</th>
                                                        <th class = "success" style = "text-align: center; font-size: 11px;">Balance</th>
